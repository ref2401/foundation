...
// intrinsics of the same names do. 
// No value conversion: asfloat(1) is not 1.0f.
export constexpr float_t asfloat(const int_t x)
{
    return bit_cast<float_t>(x);
}

export constexpr float_t asfloat(const uint_t x)
{
    return bit_cast<float_t>(x);
}

export constexpr int_t asint(const float_t x)
{
    return bit_cast<int_t>(x);
}

export constexpr int_t asint(const uint_t x)
{
    return bit_cast<int_t>(x);
}

export constexpr uint_t asuint(const float_t x)
{
    return bit_cast<uint_t>(x);
}

export constexpr uint_t asuint(const int_t x)
{
    return bit_cast<uint_t>(x);
}

export constexpr double_t asdouble(const long_t x)
{
    return bit_cast<double_t>(x);
}

export constexpr double_t asdouble(const ulong_t x)
{
    return bit_cast<double_t>(x);
}

export constexpr long_t aslong(const double_t x)
{
    return bit_cast<long_t>(x);
}

export constexpr long_t aslong(const ulong_t x)
{
    return bit_cast<long_t>(x);
}

export constexpr ulong_t asulong(const double_t x)
{
    return bit_cast<ulong_t>(x);
}

export constexpr ulong_t asulong(const long_t x)
{
    return bit_cast<ulong_t>(x);
}
